...
final case class OptionalField[P <: Path, Type, TypeInterpreter[Format[_]] <: Interpreter[Format, Type]](
  path: P,
  part: Schema.Aux[Type, TypeInterpreter],
  default: Option[Option[Type]]
) extends Schema[Option[Type]] {
  override type InternalInterpreter[Format[_]] = OptionalInterpreter[Format, P, Type, TypeInterpreter[Format]]
...
final case class RequiredField[P <: Path, Type, TypeInterpreter[Format[_]] <: Interpreter[Format, Type]](path: P, part: Schema.Aux[Type, TypeInterpreter], default: Option[Type]) extends Schema[Type] {
  override type InternalInterpreter[Format[_]] = RequiredInterpreter[Format, P, Type, TypeInterpreter[Format]]
